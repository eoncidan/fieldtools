...
function Render-Ferramentas {
    ...
    Add-Launcher -Text "Problem Steps Recorder`nPSR" -Command "psr.exe" -X 620 -Y 70              
    
    # Linha 2
    Add-Launcher -Text "Limpeza de`nDisco" -Command "cleanmgr" -X 20 -Y 180
    Add-Launcher -Text "Serviços" -Command "services.msc" -X 170 -Y 180
    Add-Launcher -Text "Conexões" -Command "ncpa.cpl" -X 320 -Y 180
    Add-Launcher -Text "Windows`nUpdate" -Command "ms-settings:windowsupdate" -X 470 -Y 180
    Add-Launcher -Text "Event Viewer" -Command "eventvwr.msc" -X 620 -Y 180             

    # Linha 3
    Add-Launcher -Text "Configuração do Sistema" -Command "msconfig" -X 20 -Y 290   
    Add-Launcher -Text "Gerenciador de Dispositivos" -Command "devmgmt.msc" -X 170 -Y 290
